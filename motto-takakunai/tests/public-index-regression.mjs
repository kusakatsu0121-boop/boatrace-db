...
// The explanatory copy may say "100%表示はしません". Only forbid an actual
// rendered score label that claims 同じ仕事率 100%.
assert.doesNotMatch(html, /同じ仕事率\s*100%/, 'public UI must never render 100% same-work');
